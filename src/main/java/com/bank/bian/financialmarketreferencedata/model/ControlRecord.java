package com.bank.bian.financialmarketreferencedata.model;
...
/**
 * The BIAN control record for this service domain: "Market Reference Data Directory Entry".
 *
 ...
 * to its asset type (Market Reference Data). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Market Reference Data Directory Entry";
